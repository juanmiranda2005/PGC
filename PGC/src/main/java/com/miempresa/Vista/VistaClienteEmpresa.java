...
public class VistaClienteEmpresa {
    ...
    private JButton btnPublicarProyecto, btnVerPostulaciones, btnSeleccionarContratista,
            btnCerrarSesion, btnHistorialProyectos;
    private VistaSeleccionarContratista vistaSeleccionarContratista;
    ...
    private VistaVerPostulaciones vistaVerPostulaciones;

    public VistaClienteEmpresa(VistaLogin vistaLogin, Map<String, Usuario> mapaUsuarios) {
        this.vistaLogin = vistaLogin;
        this.mapaUsuarios = mapaUsuarios;
        vistaVerPostulaciones = new VistaVerPostulaciones();
        vistaSeleccionarContratista = new VistaSeleccionarContratista();
        ...
        panelContenido.add(vistaVerPostulaciones.getPanel(), "Ver Postulaciones");
        panelContenido.add(new VistaHistorialProyectos().getPanel(), "Historial Proyectos");
        panelContenido.add(vistaSeleccionarContratista.getPanel(), "Seleccionar Contratista");

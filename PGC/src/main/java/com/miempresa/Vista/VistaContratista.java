...
public class VistaContratista {
    ...
    private JButton btnVerProyectos, btnVerContratos, btnActualizarEstadoContrato, btnCerrarSesion;
    ...
    public VistaContratista(VistaLogin vistaLogin, Map<String, Usuario> mapaUsuarios) {
        ...
        btnActualizarEstadoContrato = new JButton("Actualizar Estado Contrato");
        btnCerrarSesion = new JButton("Cerrar Sesión");

        // Opcional: Personalización visual de botones
        JButton[] botones = {btnVerProyectos, btnVerContratos, btnActualizarEstadoContrato, btnCerrarSesion};
    ...
    public JButton getBtnActualizarEstadoContrato() {
        return btnActualizarEstadoContrato;
    }

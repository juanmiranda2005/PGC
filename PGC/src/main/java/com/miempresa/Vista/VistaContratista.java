...
public class VistaContratista {
    ...
    private JPanel crearPanelActualizarEstado() {
        ...
        btnActualizarEstado.addActionListener(e -> {
            ...
            // Aquí agregar lógica para actualizar el estado del contrato en BaseDatos o modelo
            // Ejemplo: BaseDatos.actualizarEstadoContrato(contratoId, nuevoEstado);
    ...
    private void cargarContratosEnCombo() {
        ...
        // Cargar contratos asociados al contratista actual desde BaseDatos
        // Aquí un ejemplo para llenar el combo, debes adaptar según tu modelo:

        // Supongamos que tienes una función que devuelve los contratos:
        // List<Contrato> contratos = BaseDatos.getContratosPorContratista(idContratista);

        // Por ahora, agregar valores de ejemplo:
        comboContratos.addItem("C001 - Proyecto Alpha");
        comboContratos.addItem("C002 - Proyecto Beta");
    }
